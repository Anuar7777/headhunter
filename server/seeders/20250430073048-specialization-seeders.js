...
raw_data.forEach(
  ({ name: type_name, specializations: specializations_list }, type_id) => {
    specialization_types.push({ name: type_name });
    specializations_list.forEach(({ name: specialization_name }) => {
      specializations.push({
        specialization_type_id: type_id + 1,
...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert("SpecializationType", specialization_types);

    await queryInterface.bulkInsert("Specialization", specializations);
  },

  async down(queryInterface, Sequelize) {
    await queryInterface.bulkDelete("SpecializationType", null, {});

    await queryInterface.bulkInsert("Specialization", null, {});
  },
};
